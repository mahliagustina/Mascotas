...
localStorage.setItem("nombreSesion", nombreIngresado);

let correoElectronico = prompt("Ingresá un mail de contacto");
localStorage.setItem("mailSesion", correoElectronico);
...
alert("Tu caso fue registrado con éxito. ¡Muchas gracias! " + nombreIngresado);
sessionStorage.setItem("nombreSesion",ficha);
